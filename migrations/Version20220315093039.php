 ...
 */
final class Version20220315093039 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book CHANGE title title VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE image image VARCHAR(512) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
